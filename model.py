...
class Planting(Base):
    ...
    # need to ensure that when a planting is completed, its reminders
    # get expired. also, if a planting gets deleted, its reminders
    # and harvests should get deleted
...
class Reminder(Base):
    ...
    kind = Column(Enum('water', 'fertilize', 'harvest', 'pesticide',
            name='reminder_type',
            nullable=False))
